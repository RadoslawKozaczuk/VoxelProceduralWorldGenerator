...
namespace Realtime.Messaging
{
    ...
    public class RealtimeMessenger
    {
        ...
        private UnityTask _resumeTask;
        private UnityTask _disconnectTask;
        private UnityTask _pauseTask;
        ...
        public UnityTask Connect()
        {
            ...
            _connectionTask.Status = TaskStatus.Running;

            State = ConnectionState.Connecting;

            if (string.IsNullOrEmpty(AuthenticationToken))
                AuthenticationToken = ConnectionMetadata;
        ...
        public UnityTask Resume()
        {
            ...
            // 
            _resumeTask = new UnityTask(TaskStrategy.Custom);
            _resumeTask.Status = TaskStatus.Running;
        ...
        public UnityTask Disconnect()
        {
            ...
            _disconnectTask = new UnityTask(TaskStrategy.Custom);
            _disconnectTask.Status = TaskStatus.Running;
        ...
        public UnityTask Pause()
        {
            ...
            _pauseTask = new UnityTask(TaskStrategy.Custom);
            _pauseTask.Status = TaskStatus.Running;
            ...
            _pauseTask.Status = TaskStatus.Success;
        ...
        public UnityTask Subscribe(string channel)
        {
            ...
            _subscribeTask.Status = TaskStatus.Running;
        ...
        public UnityTask Unsubscribe(string channel)
        {
            ...
            _unsubscribeTask.Status = TaskStatus.Running;
        ...
        void _client_OnException(Exception ex)
        {
            ...
            if (_pauseTask != null)
            {
                _pauseTask.Exception = ex;
                _pauseTask.Status = TaskStatus.Faulted;
            }

            if (_resumeTask != null)
            {
                _resumeTask.Exception = ex;
                _resumeTask.Status = TaskStatus.Faulted;
            }
        ...
        {
            UnityEngine.Debug.Log("Realtime.OnDisconnected");
        ...
        {
            UnityEngine.Debug.Log("Realtime.OnConnected");
            State = ConnectionState.Connected;
