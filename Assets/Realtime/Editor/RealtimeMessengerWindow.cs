...
namespace Realtime.Editor
{
    public class RealtimeMessengersWindow : EditorWindow
    {
        ...
        {
            var instance = Resources.Load<MessengerSettings>("MessengerSettings");
            if (instance == null)
            {
                Debug.Log("RealtimeNetwork Created at Assets/Resources/MessengerSettings.asset");

                var inst = CreateInstance<MessengerSettings>();
        ...
        static MessengerSettings Target
        {
            get
            {
                if (MessengerSettings.Instance == null)
                    CreateSettings();
